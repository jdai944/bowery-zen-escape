      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-center gap-8 mb-12">
          <div className="flex items-center gap-3 bg-background/80 backdrop-blur-sm px-4 py-3 rounded-lg border shadow-sm w-[240px]">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs text-muted-foreground mx-[20px]">668 reviews</span>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll gap-6">
            {[...reviews, ...reviews].map((review, index) => <Card key={index} className="flex-shrink-0 w-80 p-6 bg-background/80 backdrop-blur-sm">

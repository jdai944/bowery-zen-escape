      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer">
              <Badge className="text-lg px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors cursor-pointer">
                Special Offers
              </Badge>
            </a>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {specials.map((special, index) => (
              <a key={index} href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="block">
                <Card className="bg-background/80 backdrop-blur-sm border-2 border-primary/20 hover:border-primary/40 transition-all cursor-pointer h-full hover:scale-[1.02]">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="block">
            <Card className="bg-background/80 backdrop-blur-sm cursor-pointer hover:shadow-lg transition-all h-full hover:scale-[1.02]">
              <CardHeader>
